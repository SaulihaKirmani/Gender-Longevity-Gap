...
- **Boundary Outlier Analysis:** Identified upper and lower tail extremes (Tukey's $1.5 \times \text{IQR}$) and highlighted socio-economic cross-tier anomalies (Central African Republic in the upper tail; Kuwait, Bahrain, and Qatar in the lower tail).
